...
function MedicareDataSource() {
    ...
    $.ajax({
        ...
        success: function (result) {
            that.setStores(that.parse_(result));
        },
 ...
 */
MedicareDataSource.prototype.parse_ = function (result) {
    var stores = [];
    //var rows = csv.split('\n');
    ...
    $.each(result, function (key, item) {
        //var features = new storeLocator.FeatureSet;
        //features.add(this.FEATURES_.getById('IsOverNight-' + item.IsOverNight));
        ...
        var store = new storeLocator.Store(item.ParkingID, position, null, {
            title: item.Name,
