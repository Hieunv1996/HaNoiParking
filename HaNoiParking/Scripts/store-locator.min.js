    ...
    */
    ...
    storeLocator.Panel = function (a, b) {
        ...
        this.settings_ = $.extend({
            locationSearch: !0,
            locationSearchLabel: "Bạn đang ở đâu?",
            featureFilter: !0,
            directions: !0,
            view: null
        }, b);
    ...
    storeLocator.Panel.prototype.init_ = function () {
        ...
        this.settings_.locationSearch && (this.locationSearch_ = $('\x3cdiv class\x3d"location-search" style="position:relative;"\x3e\x3ch4\x3e' + this.settings_.locationSearchLabel + "\x3c/h4\x3e\x3cinput style=\"margin-top:10px;\" class=\"form-control\"\x3e<img src=\"../Images/location.png\" style=\"width:25px;position:absolute;bottom:10px;right:5px;\" onclick=\"getCurrentLocation()\" />\x3c/div\x3e"), this.filter_.append(this.locationSearch_), "undefined" != typeof google.maps.places ? this.initAutocomplete_() :
        ...
        this.settings_.directions && (this.directionsPanel_ = $('\x3cdiv class\x3d"directions-panel"\x3e\x3cform\x3e\x3cinput style="width:90%;" class\x3d"directions-to form-control"/\x3e\x3cinput type\x3d"submit" style="margin-top: 10px;" class="btn btn-success" value\x3d"Tìm đường"/\x3e\x3ca href\x3d"#" class\x3d"close-directions btn btn-default" style="padding-left:20px;margin-top:10px;margin-left:30px;"\x3eClose\x3c/a\x3e\x3c/form\x3e\x3cdiv class\x3d"rendered-directions"\x3e\x3c/div\x3e\x3c/div\x3e'), this.directionsPanel_.find(".directions-to").attr("readonly", "readonly"), this.directionsPanel_.hide(),
    ...
    storeLocator.Panel.NO_STORES_HTML_ = '\x3cli class\x3d"no-stores"\x3eKhông có bãi đỗ trong khu vực.\x3c/li\x3e';
    storeLocator.Panel.NO_STORES_IN_VIEW_HTML_ = '\x3cli class\x3d"no-stores"\x3eDanh sách các bãi đỗ gần nhất.\x3c/li\x3e';
    ...
    storeLocator.Panel.prototype.selectedStore_changed = function () {
        ...
        if (b) {
            ...
            var c = a.get("view").getInfoWindow().getContent(),
                ...
                g = $("\x3ca/\x3e").text("View Comments").attr("href", "#").addClass("action").addClass("detail");
            d.click(function () {
                a.showDirections();
                return !1
            });
            ...
            $(c).append(d).append(e).append(f).append(g)
        }
    };
    ...
    storeLocator.Panel.prototype.renderDirections_ = function () {
        var a = this;
        if ($('.location-search input').val().replace(/\s/g, '').toLowerCase() == 'mylocation') {
            this.directionsFrom_ = currentLocation;
        }
