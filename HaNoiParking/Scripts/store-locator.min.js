(function ($) {
    ...
    */
    ...
    storeLocator.Panel.prototype.init_ = function () {
        ...
        this.settings_.directions && (this.directionsPanel_ = $('\x3cdiv class\x3d"directions-panel"\x3e\x3cform\x3e\x3cinput style="width:95%;" class\x3d"directions-to form-control"/\x3e\x3cinput type\x3d"submit" style="margin-top: 10px;" class="btn btn-success" value\x3d"Tìm đường"/\x3e\x3ca href\x3d"#" class\x3d"close-directions btn btn-default" style="padding-left:20px;"\x3eClose\x3c/a\x3e\x3c/form\x3e\x3cdiv class\x3d"rendered-directions"\x3e\x3c/div\x3e\x3c/div\x3e'), this.directionsPanel_.find(".directions-to").attr("readonly", "readonly"), this.directionsPanel_.hide(),
    ...
    storeLocator.Panel.prototype.selectedStore_changed = function () {
        ...
        if (b) {
            ...
            var c = a.get("view").getInfoWindow().getContent(),
                ...
                g = $("\x3ca/\x3e").text("View Detail").attr("href", "#").addClass("action").addClass("detail");
            d.click(function () {
                a.showDirections();
                return !1
            });
